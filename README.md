...
- 🤖 **GenAI:** Leveraging Claude/LLMs for SQL optimization and faster data storytelling.

### 🛠 Tech Stack
- **Languages:** SQL (Advanced), Python (Pandas, NumPy), Google Apps Script.
- **Visualization:** Power BI, Advanced Google Sheets, Dashboarding.
- **Analytics:** Funnel Analysis, Cohort Analysis, User Segmentation.
- **AI Tools:** Claude (Prompt Engineering for Data Analysis).
